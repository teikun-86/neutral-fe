    ...
    <AppLayout title={`Not Found ー ${process.env.NEXT_PUBLIC_APP_NAME} ${process.env.NEXT_PUBLIC_APP_SLOGAN}`}>
        <div className="w-full py-12 max-w-7xl mx-auto grid place-items-center min-h-[70vh]">
            <div className="flex items-center justify-center flex-col">
                ...
                <h1 className="text-2xl font-bold text-gray-800 mb-3">Hohoho... sepertinya ada yang tersesat</h1>
                <p className="text-gray-600">Sepertinya halaman yang kamu cari gak ketemu, tapi jangan khawatir, yuk, ke halaman utama!</p>

...
export const UnderlinedLink = ({active = false, as = "link", href = "/", ...props}) => {
    ...
    let classes = active
        ...
        : "text-gray-800 dark:text-gray-200 hocus:text-rose-500 hocus:after:w-2/3 hocus:after:h-0.5 hocus:after:bg-rose-600 hocus:after:absolute hocus:after:bottom-0.5 hocus:after:animate-width-2/3 hocus:after:transition-all hocus:after:duration-200 hocus:after:left-0"
